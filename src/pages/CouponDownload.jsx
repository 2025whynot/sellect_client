  ...
  const fetchCoupons = async (currentPage = 0) => {
    try {
      ...
      const response = await fetch(
        `${VITE_API_BASE_URL}/api/v1/coupon/actives?page=${currentPage}&size=${size}`,
        {
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {coupons.map((coupon) => (
              <div
                key={
                  coupon.coupon_info.seller_info.seller_id +
                  coupon.coupon_info.expiration_date
                } // 고유 키 생성
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    <span className="font-medium text-indigo-600">
                      {coupon.coupon_info.seller_info.seller_nickname}
                    </span>
                  </p>
                ...
                <button
                  onClick={() =>
                    handleRegisterCoupon(coupon.coupon_info.coupon_id)
                  } // seller_id를 couponId로 사용 가정
